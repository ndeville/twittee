...
# Use pprint() to prettyprint output.

#tweet_data = search_handle_recent("siemens",keywords=['a','the world of'],daylimit=7,blacklist=[])
#tweet_data = search_specific_handle("siemens",keywords=["like"],daylimit=7,limit=10)
tweet_data = generic_search(daylimit=7, keywords=['virtual event'],limit=200)
pprint(tweet_data)
